...
//! and *schedule* (chosen per [`unpopped_vocab::StructureKey`] cell).
...
pub enum View {
    ...
    /// The named IR form of what [`unpopped_vocab::OperandKey`]'s
...
impl View {
    ...
    /// [`unpopped_vocab::StructureKey`] deliberately abstracts numeric
    /// extents away.
    #[must_use]
...
/// many [`unpopped_vocab::StructureKey`] cells (the schedule half).
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct OpDef {
